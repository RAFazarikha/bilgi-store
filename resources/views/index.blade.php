    ...
    <body class="leading-normal tracking-normal text-white-100 gradient">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <ul class="list-reset lg:flex justify-end flex-1 items-center">
                <li class="mr-3">
                <a class="inline-block py-2 px-4 text-blue font-bold no-underline" href="#">Active</a>
                </li>
                <li class="mr-3">
                <a class="inline-block text-blue no-underline hover:text-blue hover:text-underline py-2 px-4" href="#">link</a>
                </li>
                <li class="mr-3">
                <a class="inline-block text-blue no-underline hover:text-blue hover:text-underline py-2 px-4" href="#">link</a>
                </li>
        ...
        <section class="bg-white-100 border-b py-8">
        ...
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div class="flex-1 bg-white-100 rounded-t rounded-b-none overflow-hidden shadow">
                <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                <p class="w-full text-blue text-xs md:text-sm px-6">
                    xGETTING STARTED
                </p>
                <div class="w-full font-bold text-xl text-blue px-6">
                    Lorem ipsum dolor sit amet.
                </div>
                <p class="text-blue text-base px-6 mb-5">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
                </p>
                </a>
            </div>
            <div class="flex-none mt-auto bg-white-100 rounded-b rounded-t-none overflow-hidden shadow p-6">
